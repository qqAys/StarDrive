...
class Role(SQLModel, table=True):
    ...
    id: str = Field(default_factory=lambda: str(generate_ulid()), primary_key=True, max_length=26)
    name: str = Field(unique=True, index=True, max_length=32)  # 例如: "admin", "editor", "user"
